...
vector <string> Fixed62; // 6-나가기
vector <string> Fixed63; // 6-쉬기
...
void addEvtscript()
{
	...
	Fixed3.push_back("앙보승띠 : 아니 니가 그렇게 술게임을 잘해?");
	...
	Fixed62.push_back("오늘은 첫 데이트 날");
	Fixed62.push_back("지난번에 우연히 만난 이후로");
	Fixed62.push_back("몇 번의 만남을 더 가진 후에 우리는 연인이 되었다.");
	...
	Ran1.push_back("오늘은 너가 어려워하는 포인터와 배열에 대해 알아보자.");
	Ran1.push_back("");//갓현석
	...
	Ran2.push_back("김태양 : 아니 이걸 안 와? 이걸 뺀다고?");
	...
	Ran2.push_back("김태양 : 그거 니가 못 하는 거야 그 교수님 갓교수님이야. ");
	Ran2.push_back("");
	Ran2.push_back("");//김태양
...
void addEndscript()
{
	...
	Celeb.push_back("만능 엔터테이너 [이름]님을 모셨습니다!!");
	Celeb.push_back("[이름]씨, 인기가 많으면 피곤하진 않으세요?");
